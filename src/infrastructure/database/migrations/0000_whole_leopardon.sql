...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "chats" ADD CONSTRAINT "chats_insight_id_insights_id_fk" FOREIGN KEY ("insight_id") REFERENCES "public"."insights"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "saved_passages" ADD CONSTRAINT "saved_passages_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "insights_created_at_idx" ON "insights" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "insights_favorite_idx" ON "insights" USING btree ("user_id","is_favorite");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "chats_updated_at_idx" ON "chats" USING btree ("updated_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "passages_user_id_idx" ON "saved_passages" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "passages_created_at_idx" ON "saved_passages" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "passages_bookmark_idx" ON "saved_passages" USING btree ("user_id","is_bookmark");--> statement-breakpoint
